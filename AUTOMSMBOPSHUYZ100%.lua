-- MBOPS'C UHUY.Z -- REDESIGNED: DEEP PURPLE THEME + TEXT SIDEBAR
...
do
	...
	ver.Text = "MBOPS'C UHUY.Z  •  Deep Purple Edition"
...
closeBtn.MouseButton1Click:Connect(function()
	...
	notify("MBOPS'C", "Script dihentikan.", "error")
	task.wait(0.4)
	gui:Destroy()
end)
...
ContextActionService:BindAction("toggleUI_MBOPS'C", function(_, state)
...
switchTab("FARM")
task.wait(0.3)
notify("MBOPS'C UHUT.Z", "Script berhasil diload!", "success")
